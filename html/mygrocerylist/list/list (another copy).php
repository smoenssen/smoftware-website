                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <span class="pull-right">
                            <span class='btn btn-xs btn-default' style='border:none;' onclick="location.href='../'; event.stopPropagation();">
                                <span data-toggle='tooltip' title='Add grocery items' class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                            </span>
                        </span></a>
